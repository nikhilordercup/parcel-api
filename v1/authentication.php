    ...
    if(!$isUserExists){
        ...
        if ($user != NULL) {
            ...
            $db->save("configuration", array(
                    "configuration_json"=>'{"username":"roopesh","password":"ROOPESH","port":"25","host":"LOCALHOST","maximum_allow_drop":"40","buffer_time":"100","maxbuffertimeperdrop":"000","maxbuffertimepershipment":"0","whscanautoatrue":"1","driverscanautoatrue":"1","regularattempt":"2","phonetypeattempt":"1","round_trip":"NO","driving_mode":"BICYCLING"}',
