...
use v1\module\Database\Model\ChargebeePlansModel;

class ChargebeeHelper extends \Icargo
{
    ...
    /**
     * ChargebeeHelper constructor pass empty array for $data if you are not verifying user.
     * @param $data
     */
    ...
    /**
     * Configure Chargebee configuration.
     */
    private function _chargeAPiInvironment()
    {
    ...
    /**
     * Create a new plan on Chargeebee
     * @param $param
     * @return mixed|null
     * @throws \Exception
     */
    private function _createPlan($param)
    {
        try {
    ...
    /**
     * Update any existing plan information
     * @param $param
     * @return mixed|null
     */
    private function _updatePlan($param)
    {
        try {
     ...
     * @throws \Exception
     */
    private function _createSubscription($param)
    {
        try {
            $data = array(
    ...
    /**
     * Modify any existing subscription information
     * @param $param
     * @param $subscription_id
     * @return array
     * @throws \Exception
     */
    private function _updateSubscription($param, $subscription_id)
    {
        try {
            $data = array(
                "planId" => $param["plan_id"],
    ...
    /**
     * Register your customer on Chargebee
     * @param $param
     * @return mixed
     */
    private function _createCustomer($param)
    {
        ...
        /**
         * @var $customer \ChargeBee_Customer
         */
        $customer = $result->customer();
        $data = $customer->getValues();
        $data['chargebee_customer_id'] = $data['id'];
        return $data;
    }

    /**
     * Update customer information on Chargebee side
     * @param $param
     * @param $chargebee_customer_id
     * @return array
     */
    private function _updateCustomer($param, $chargebee_customer_id)
    {
    ...
    /**
     * Save Credit Card information on Chargebee side
     * @param $param
     * @param $customer_id
     * @return array
     * @throws \Exception
     */
    private function _saveCustomerCard($param, $customer_id)
    {
        try {
    ...
    /**
     * Save new plan information in local database and calling Chargebee plan create function.
     * @param $param
     * @return array
     */
    ...
    /**
     * List all Chargebee subscription  plans.
     * @return array
     */
    ...
    /**
     * Update plan information for Chargebee and local database
     * @param $param
     * @return array
     */
    ...
    /**
     * Get any particular subscription information
     * @param $param
     * @return array
     */
    ...
    /**
     * Get list of all available active subscription
     * @return array
     */
    ...
    public function createSubscription($param)
    {
        try {
            ...
            unset($data['customer_id']);//print_r($param);exit;
            $planInfo = ChargebeePlansModel::all()
                ->where('plan_id', '=', $param->plan_id)->first();
            $data['plan_type'] = $planInfo->plan_type == 'SAME_DAY' ? str_replace('_', '', $planInfo->plan_type) : $planInfo->plan_type;
    ...
    /**
     * Edit any existing subscription information
     * @param $param
     * @return array
     */
    public function editSubscription($param)
    {
        try {
            $data = array(
                "plan_id" => $param->plan_id,
    ...
    /**
     * Register customer on local database and Chargebee
     * @param $param
     * @return array
     */
    ...
    /**
     * Fetch customer information from Chargebee
     * @param $param
     * @return array
     */
    ...
    /**
     * Edit customer information on Chargebee and local database.
     * @param $param
     * @return array
     */
    ...
    public function listAllCustomerAndPlanForSubscription()
    {
        //list lcustomer
    ...
    public function getPlanDetailForSubscription($param)
    {
        //list lcustomer
    ...
    public function upgradeCustomerPlan($param)
    {
        try {
            $customerPlan = $this->modelObj->getCustomerCurrentPlan($param);
    ...
    public function cancelSubscription($chargebee_subscription_id)
    {
        \ChargeBee_Subscription::delete($chargebee_subscription_id);
    }
}