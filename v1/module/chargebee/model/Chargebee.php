...
class Chargebee_Model_Chargebee
	...
	function updatePlan($param, $plan_id)
		{
		//save record to table
	...
	function updateSubscription($param, $subscription_id)
		{
		//save record to table
	...
	function updateCustomer($param, $chargebee_customer_id)
		{
		//save record to table
	...
	function listAllCustomerForSubscription()
		{
		//list all plan
	...
	function listAllPlanForSubscription()
		{
		//list all plan
	...
	function getPlanDetailForSubscription($plan_id)
		{
		//list all plan
	...
	function getCustomerPlanById($chargebee_customer_id)
		{
		//list all plan
	...
	function updateCustomerNextBillingDate($param)
		{
		//list all plan
