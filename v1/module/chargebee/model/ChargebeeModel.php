...
class ChargebeeModel {
    ...
    /**
     * @return ChargebeeModel
     */
    public static function getInstanse() {
        if (ChargebeeModel::$model_instance == null) {
            ChargebeeModel::$model_instance = new ChargebeeModel();
            ChargebeeModel::$db = new \DbHandler();
        }
        return ChargebeeModel::$model_instance;
    }

    private function _db() {
        return ChargebeeModel::$db;
    }
