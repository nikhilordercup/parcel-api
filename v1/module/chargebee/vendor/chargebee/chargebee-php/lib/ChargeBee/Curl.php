...
class ChargeBee_Curl {
    ...
    /*echo $env->apiUrl($url)."<br>";
    echo ChargeBee_Environment::$connectTimeout."<br>";
    echo ChargeBee_Environment::$timeout."<br>";
    echo "Chargebee-PHP-Client" . " v" . ChargeBee_Version::VERSION."<br>";
    $httpHeaders = self::addCustomHeaders($headers);
    print_r($httpHeaders);echo "<br>";

    $userAgent = "Chargebee-PHP-Client" . " v" . ChargeBee_Version::VERSION;
    echo "Accept: application/json, User-Agent: " . $userAgent."<br>";



    echo $env->getApiKey() . ':<br>';
    echo ChargeBee::getVerifyCaCerts()."<br>";
    echo ChargeBee::getCaCertPath()."--";*/
        $curl = curl_init();
        $opts = array();
