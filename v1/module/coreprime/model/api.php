...
class Coreprime_Model_Api
{
    ...
    public function getCustomerCcfByCustomerId($id){
    ...
    public function isServiceAvailableforCustomer($service_code,$customer_id,$company_id,$courier_id){
    ...
    public function getCustomerSamedayServiceData($customer_id,$company_id,$courier_id){
    ...
    public function getCarrierIdByCode($companyId,$customerid,$account){  
