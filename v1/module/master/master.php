...
class Master extends Icargo{
    ...
    */
     ...
     /* public function getAllCourierServices($param){
	  ...
	  public function findServiceAccountByServiceId($service_id)
		{
			...
			$sql .= " WHERE CSCT.service_id='$service_id'";
    ...
    public function getAllCourierServices($param)
    {
	    $result = array();
			...
			foreach($data as $item){
					$accountNo = $this->findServiceAccountByServiceId($item["service_id"]);
            ...
            // Create Services
                ...
                if(count($allServices)>0){
                    foreach($allServices as $key=>$vals){
                      ...
                      $this->_parentObj->db->save("courier_vs_services_vs_company", $tempservices);
                    }
                }
                // Create Surcharge
