...
class Load_Assign_Model extends Shipment_Model
    ...
    function getRouteDetails($shipment_str, $access_token)
        {
        $sql = "SELECT t1.load_identity,t1.shipment_type,t1.drag_temp_route_id, t1.execution_order, t1.drop_execution_order, "
                . "t1.temp_shipment_ticket, t1.distancemiles, t1.estimatedtime, t2.route_id, t2.route_name, t2.is_optimized, "
                . "t2.optimized_type, t2.last_optimized_time, t2.route_type FROM " . DB_PREFIX . "temp_routes_shipment AS t1 ";
