...
class shipment extends Library
{
    ...
    function _findPriceNextVersionNo($load_identity)
    {
    ...
    function _bookSameDayShipment($param)
    {
        ...
        if ($address["status"] == "success") {
            ...
            if ($shipmentStatus["status"] == "success") {
                ...
                return array("status" => "success", "load_identity" => $load_identity, "address_id" => $address["address_id"]);
            } else {
    ...
    function _prepareShipmentData($param)
    {
        ...
        $_data["address_id"] = (isset($_data["
		address_list"]->id)) ? $_data["address_list"]->id : "";
    ...
    function bookSameDayShipment($data)
    {
        ...
        if ($customerStatus) {
            ...
            foreach ($data->collection_address as $shipment_data) {
                ...
                $shipmentStatus = $this->_bookSameDayShipment(array("shipment_data" => $shipmentData, "address_op" => $data->address_op));
