...
class Idriver_Auth
{
    ...
    {
        $sql    = "SELECT * FROM " . DB_PREFIX . "system_configuration AS T1 WHERE T1.configuration_type='APP' AND T1.company_id='$company_id'";
        $record = $this->db->getRowRecord($sql);
        return $record;
    }
                        ...
                        if ($vehicle_detail['vehicleTypeName'] != null) {
                            ...
                            if (count($appConfiguration) > 0) {
                                ...
                                $response['warehouse']   = array(
                                    ...
                                    "system_configuration" => $appConfiguration
                                );
                            } else {
