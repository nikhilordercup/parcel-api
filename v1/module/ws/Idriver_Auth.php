                            ...
                            if (count($appConfiguration) > 0) {
                                ...
                                $response = array(
                                    ...
                                    "warehouse" => array(
                                        ...
                                        "warehouse_form" => base64_encode($formData)
                                    ),
                                    "system_configuration"=>$appConfiguration["config_data"],
                                    "form_json"=>$appConfiguration["form_json"]
